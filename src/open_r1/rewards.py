...
from open_r1.utils.haldet_utils import get_score_align_reward, get_vote_score_align_reward
...
def get_reward_funcs(script_args) -> list[Callable]:
    REWARD_FUNCS_REGISTRY = {
        ...
        "score_align": get_score_align_reward,
        "vote_score_align": get_vote_score_align_reward
    }
